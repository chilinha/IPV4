...
#enter
file_paths = ["txt_files/北京联通.txt", "txt_files/河北联通.txt", "txt_files/广西电信.txt", "txt_files/Sus.txt"]
...
#enter
file_paths = ["txt_files/四川电信.txt", "txt_files/山东联通.txt", "txt_files/Susaw.txt"]
