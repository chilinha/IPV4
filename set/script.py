...
#enter
file_paths = ["txt_files/北京联通.txt", "txt_files/河北联通.txt", "txt_files/山东联通.txt", "txt_files/Sus.txt"]
...
#enter
file_paths = ["txt_files/天津联通.txt", "txt_files/河南联通.txt", "txt_files/Susa.txt"]
...
#enter
file_paths = ["txt_files/四川电信.txt", "txt_files/广西电信.txt", "txt_files/Susaw.txt"]
...
#enter
file_paths = ['txt_files/Sus.txt','txt_files/Susa.txt','txt_files/Susaw.txt']
...
keywords = ['CCTV','CCTV欧','CCTV美','CETV', 'CF', 'CHC', 'IWA', '凤凰卫视', '星空', 'CHANNEL', 'W','卫视', 'X','Y','Z']  #enter
...
cctv_order = [
    ...
    "CCTV16", "CCTV17", "CCTV4欧洲", "CCTV4美洲", "风云足球", "高尔夫网球", "央视台球", 
    "第一剧场", "风云剧场", "怀旧剧场", "世界地理", "兵器科技", "女性时尚", 
    "风云音乐", "央视文化精品", "电视指南", "CETV1", "CETV4", "早期教育"
]

satellite_order = [
    "安徽卫视", "北京卫视", "重庆卫视", "东方卫视", "东南卫视", "甘肃卫视", "广东卫视", 
    "广西卫视", "贵州卫视", "海南卫视", "河北卫视", "河南卫视", "黑龙江卫视", 
    "湖北卫视", "湖南卫视", "吉林卫视", "江苏卫视", "江西卫视", "辽宁卫视", 
    "青海卫视", "三沙卫视", "山东卫视", "深圳卫视", "四川卫视", "天津卫视", 
    "云南卫视", "浙江卫视", "陕西卫视", "山西卫视", "内蒙古卫视", "宁夏卫视", 
    "西藏卫视", "新疆卫视", "兵团卫视"
]

digital_order = [
    "CHC家庭影院", "CHC动作电影", "CHC影迷电影", "求索纪录", "北京纪实科教", "纪实人文", 
    "金鹰纪实", "乐游", "魅力足球", "游戏风云", "金色学堂", "生活时尚", 
    "都市剧场", "欢笑剧场", "动漫秀场", "卡酷少儿", "金鹰卡通", "优漫卡通"
]

tianjin_order = [
    "天津新闻", "天津文艺", "天津影视", "天津都市", "天津体育", "天津教育"
]
...
for line in lines:
    ...
    if stripped_line.startswith("央视, #genre#"):
        ...
        other_lines.append(stripped_line)
    elif stripped_line.startswith("天津, #genre#"):
        current_category = "tianjin"
        other_lines.append(stripped_line)
    else:
        ...
        elif current_category == "tianjin":
            tianjin_channels.append(stripped_line)
        else:
            other_lines.append(stripped_line)
...
sorted_tianjin = sort_by_order(tianjin_channels, tianjin_order)
...
for line in other_lines:
    if line == "央视, #genre#":
        ...
        final_output.append(line)
        final_output.extend(sorted_tianjin)
    else:
        final_output.append(line)
